        ...
        <div className="rounded-2xl border overflow-hidden" style={{ borderColor: '#2a2a2a', background: '#111' }}>
          ...
          <div className="border-b px-8 py-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4" style={{ borderColor: '#2a2a2a', background: '#161616' }}>
            ...
            <div className="flex gap-3">
              <div className="text-center px-4 py-2 rounded-lg border" style={{ borderColor: '#2a2a2a', background: '#0d0d0d' }}>
                <div className="text-lg font-black" style={{ color: '#f87171' }}>1</div>
                <div className="text-xs" style={{ color: '#8f8f8f' }}>Critical issue</div>
              </div>
              <div className="text-center px-4 py-2 rounded-lg border" style={{ borderColor: '#2a2a2a', background: '#0d0d0d' }}>
                <div className="text-lg font-black" style={{ color: '#f97316' }}>3</div>
                <div className="text-xs" style={{ color: '#8f8f8f' }}>Gaps found</div>
              </div>
              <div className="text-center px-4 py-2 rounded-lg border" style={{ borderColor: '#2a2a2a', background: '#0d0d0d' }}>
                <div className="text-lg font-black" style={{ color: '#22c55e' }}>$4,300</div>
                <div className="text-xs" style={{ color: '#8f8f8f' }}>Mo. opportunity</div>
              </div>
            </div>
          </div>
          ...
          <div className="p-8 grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="rounded-xl border p-5 mb-4" style={{ borderColor: '#f87171', background: 'rgba(239,68,68,0.04)' }}>
                <div className="flex items-start gap-3 mb-3">
                  <div className="w-8 h-8 rounded-lg flex items-center justify-center shrink-0" style={{ background: 'rgba(239,68,68,0.15)' }}>
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M8 2L14 12H2L8 2Z" stroke="#f87171" strokeWidth="1.5" strokeLinejoin="round"/><path d="M8 7V9M8 11V11.5" stroke="#f87171" strokeWidth="1.5" strokeLinecap="round"/></svg>
                  </div>
                  <div>
                    <div className="text-xs font-semibold mb-0.5" style={{ color: '#f87171' }}>PRIMARY BOTTLENECK</div>
              ...
              <div className="space-y-3">
                <div className="rounded-lg border p-4" style={{ borderColor: '#2a2a2a', background: '#161616' }}>
                  <div className="text-xs mb-2" style={{ color: '#8f8f8f' }}>Response time comparison</div>
                  <div className="space-y-2">
                    <div>
                      <div className="flex justify-between text-xs mb-1">
                        <span style={{ color: '#a3a3a3' }}>Your avg.</span>
                        <span className="font-bold" style={{ color: '#f87171' }}>52 min</span>
                      </div>
                ...
                <div className="rounded-lg border p-4" style={{ borderColor: '#2a2a2a', background: '#161616' }}>
                  <div className="text-xs mb-2" style={{ color: '#8f8f8f' }}>Suggested fix</div>
                ...
                <div className="space-y-2 text-xs">
                  {[
                    ...
                    <div key={row.period} className="flex justify-between py-1.5 border-b last:border-0" style={{ borderColor: '#2a2a2a' }}>
                      ...
                      <span className="font-bold" style={{ color: '#f87171' }}>{row.cost}</span>
                    </div>
                  ))}
                </div>
              </div>
